Diplomatura-UTN
API Fintech - Gestión de Clientes y Cuentas
...
Lombok (Optimización de código repetitivo/Boilerplate mediante anotaciones)
...
git clone https://github.com/melurodriguez/Diplomatura-UTN.git
cd <NOMBRE_DE_TU_PROYECTO>

## Configurar la Base de Datos (MySQL)
Crea una base de datos en tu entorno local llamada fintech_db. Luego, configura tus credenciales en el archivo src/main/resources/application.properties
...
spring.datasource.password=TU_CONTRASENIA_DE_MYSQL
...
Para validar la lógica de negocio, el mapeo de herencia polimórfica y la robustez del manejo de excepciones ante fallos o llamadas a la API externa:
